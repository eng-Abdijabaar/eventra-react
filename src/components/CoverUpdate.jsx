...
const CoverUpdateModel = ({ previewImg, file, onCancel }) => {
    const { isLoading, error, updateCover } = useUserStore();
    ...
    const handleConfirmUpdate = async () => {
        try {
            ...
            await updateCover(token, formData);
            onCancel(); // Close preview upon success
        ...
        <div className="bg-white shadow-sm pb-6">
            <div className="max-w-5xl mx-auto w-full">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 className="text-xl font-bold text-gray-900">Update Cover Photo</h2>
...
export default CoverUpdateModel;